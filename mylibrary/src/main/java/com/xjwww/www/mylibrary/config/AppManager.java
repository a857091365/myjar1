...
public class AppManager {
    ...
    private static Stack<FragmentActivity> fragmentActivityStack;
    ...
    /**
     * 结束所有FragemntActivity
     */
    public void finishAllFragmentActivity() {
        if (fragmentActivityStack != null) {

            for (int i = 0, size = fragmentActivityStack.size(); i < size; i++) {
                if (null != fragmentActivityStack.get(i)) {
                    fragmentActivityStack.get(i).finish();
                }
            }
